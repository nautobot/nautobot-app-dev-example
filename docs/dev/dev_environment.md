...
<<<<<<< HEAD
- `nautobot_ver`: the version of Nautobot to use as a base for any built docker containers (default: 2.4.11)
=======
...
- `project_name`: the default docker compose project name (default: `nautobot-dev-example`)
...
=======
#14 naming to docker.io/nautobot-dev-example/nautobot:2.4.20-py3.12 done
>>>>>>> 2fc35f3 (Cookie updated by NetworkToCode Cookie Drift Manager Tool)
```
...
=======
ee90fbfabd77   nautobot-dev-example/nautobot:2.4.20-py3.12  "nautobot-server rqw…"   16 seconds ago   Up 13 seconds                                               nautobot_dev_example_worker_1
b8adb781d013   nautobot-dev-example/nautobot:2.4.20-py3.12  "/docker-entrypoint.…"   20 seconds ago   Up 15 seconds   0.0.0.0:8080->8080/tcp, :::8080->8080/tcp   nautobot_dev_example_nautobot_1
d64ebd60675d   nautobot-dev-example/nautobot:2.4.20-py3.12  "mkdocs serve -v -a …"   25 seconds ago   Up 18 seconds   0.0.0.0:8001->8080/tcp, :::8001->8080/tcp   nautobot_dev_example_docs_1
>>>>>>> 2fc35f3 (Cookie updated by NetworkToCode Cookie Drift Manager Tool)
...
So for example, our app is named `nautobot-dev-example`, the command would most likely be `docker logs nautobot_dev_example_nautobot_1 -f`. You can find the name of all running containers via `docker ps`.
...
```python
namespace = Collection("nautobot_dev_example")
namespace.configure(
    {
        "nautobot_dev_example": {
            ...
...
Or set the `INVOKE_NAUTOBOT_DEV_EXAMPLE_PYTHON_VER` variable.
...
Or set the `INVOKE_NAUTOBOT_DEV_EXAMPLE_NAUTOBOT_VER` variable.
